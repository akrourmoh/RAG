...
def ask_question(user_question: str):
    ...
    # Step 3: Create final prompt (FIXED: no backslash inside f-string expression)
...
"""
    ...
    answer_messages = [
        SystemMessage(
            content=(
                "You are a helpful assistant that answers questions based on provided documents and "
